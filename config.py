...
# ----------------------------------------------------------------
LOGGER_ID = int(getenv("LOGGER_ID",-1002267263891))
...
# ----------------------------------------------------------------
# ----------------------------------------------------------------
SOURCE = getenv("SOURCE", "https://github.com/VIP-CHOR/Amitamusic_cloner")
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/VIP-CHOR/Amitamusic_cloner",
)
...
HELP_IMG_URL = getenv(
    "HELP_IMG_URL", "https://files.catbox.moe/9822re.jpg"
)

PING_IMG_URL = getenv(
    "PING_IMG_URL", "https://files.catbox.moe/mns5rb.jpg"
)
PLAYLIST_IMG_URL = "https://i.ibb.co/gL3ykkyh/play-music.jpg"
STATS_IMG_URL = "https://files.catbox.moe/v1gz0m.jpg"
